...
were used to classify a data set of breast cancer into two categories: Malignant and Benign. KNN had a slightly higher accuracy and sensitivity than Naive Bayes. This suggests that KNN is a better method for this particular data set.
